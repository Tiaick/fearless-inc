...
export default function GaleriePage() {
  ...
  const gefiltert = aktiveKategorie === 'Alle' ? galerieItems : galerieItems.filter(i => i.category === aktiveKategorie);
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 40px' }}>
          <ScrollReveal>
            ...
            <p className="f-body" style={{ fontSize: '1rem', lineHeight: 1.8, color: 'var(--dim)', maxWidth: '480px' }}>
              {galerieItems.length} Arbeiten — jedes Stück entstand aus Beratung, individuellem Design und präziser Ausführung.
            </p>
          </ScrollReveal>
        </div>
      </section>
                  ...
                  <div className="img-cell" style={{ display: 'block' }}>
                    <div style={{ position: 'relative', width: '100%', aspectRatio: `${item.w}/${item.h}`, overflow: 'hidden' }}>
                      <Image
                        ...
                        alt={item.alt}
                        fill
                        style={{ objectFit: 'cover', contrast: '1.05' } as React.CSSProperties}
                      />
                      {/* hover overlay */}
                      <div style={{
